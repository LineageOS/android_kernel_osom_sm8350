...
#if defined (COMPATIBLE)
    bf_chip_info();
    /*if(g_chip_type != 0x5183 && g_chip_type != 0x5283 && g_chip_type != 0x5383 && g_chip_type != 0x5483 && g_chip_type != 0x5783 && g_chip_type != 0x5B83 && g_chip_type != 0x5883 && g_chip_type != 0x5683 && g_chip_type != 0x5a83 && g_chip_type != 0x6183) {
